...
echo "  Feedback:   feedback_report, feedback_read, feedback_stats   (opt-in; see below)"
...
echo ""
echo "To ship agent feedback to the shared server (https://swarmrt-feedback.fly.dev),"
echo "export SWARMRT_FEEDBACK_ENABLED=1 in your shell rc. Without that env var,"
echo "feedback_report does nothing — no surprise telemetry, no data leaves your"
echo "machine by default. feedback_read and feedback_stats are always on (they're"
echo "read-only public GETs)."
